...
.anreizmatrix tbody tr:hover td{ background:#f9fbff; }
.anreizmatrix td, .anreizmatrix td p, .anreizmatrix ul, .anreizmatrix li{
  font-size:0.98rem !important;
  line-height:1.45 !important;
}
.anreizmatrix ul{ margin:.1em 0 .25em 1.05em; padding:0; list-style:disc outside; }
.anreizmatrix li{ margin:.08em 0; }
.anreizmatrix table :is(th,td):nth-child(1){ width:18% !important; white-space:nowrap; font-weight:700; }
.anreizmatrix table :is(th,td):nth-child(2){ width:39% !important; }
.anreizmatrix table :is(th,td):nth-child(3){ width:43% !important; }
...
/* Tabellenzellen (jetzt mit zuverlässiger Höhe) */
.anreizmatrix_2 table tbody > tr > td{
  padding-block:1.4em !important;     /* mehr vertikaler Raum */
  padding-inline:.7em !important;     /* gleiches Seitenpadding */
  vertical-align:middle !important;
  border-bottom:1px solid #eef2f7;
}

/* Sicherheit: Theme-Overrides neutralisieren */
.anreizmatrix_2 table tbody > tr{ height:auto !important; }

/* dezentes Hover-Zebra */
.anreizmatrix_2 tbody tr:hover td{ background:#fcfdff; }

/* Umbrüche */
.anreizmatrix_2 th, .anreizmatrix_2 td{ overflow-wrap:anywhere; }
.anreizmatrix_2 ul{ margin:0 0 .1em 1.05em; padding:0; }
...
<ul>
  ...
  <li>Wer übernimmt <b>welche Verantwortung</b>?</li>
</ul>
