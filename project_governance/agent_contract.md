...
20. Sobald im Blog `draft: false` gesetzt ist, muessen alle OER-Pflichtfelder vollstaendig und valide befuellt sein; unvollstaendige OER-Metadaten sind dann ein Finalisierungsblocker.
