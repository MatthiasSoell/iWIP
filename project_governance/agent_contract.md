...
- `BLOG FINAL` finalisiert den Blog mit allen Mindestpruefungen, fuehrt nach der inhaltlichen Finalisierung das technische Content-Emoji-Postprocessing ueber `prompts/content_emojis_blog.md` auf der aktuellen `index.md` aus und loest danach den Wissensbasis-Hook aus.
