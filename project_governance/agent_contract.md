...
- Das Signal `/PLAN FORSCHUNG` hat Vorrang vor allgemeinem `/PLAN`-Routing und aktiviert den Forschungsmodus sofort; diese Aktivierung wird weder auf spaetere Rueckfragen noch auf Folgegates verschoben.
